...
int main() { // main
    ...
    for (int i = 0; i < a; i++) { // firstfor
        ...
        if (str[1] == '/') { // 닫는 태그일 때
            ...
            if (now != NULL)
            cout << "now's before: " << now->num_value << endl;
            else
            cout << "now's before : NULL" << endl;
            /*
            ...
            cout << "v" << v.size() << " number: " << now->num_value << endl << endl;
            /*
            cout << "v" << v.size() << " name: " << v[count - 1].name[count - 1] << endl;
            cout << " value: " << v[count - 1].value[count - 1] << endl;
